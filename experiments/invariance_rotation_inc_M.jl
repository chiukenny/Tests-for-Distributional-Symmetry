...
for i in 1:length(Ms)
    ...
    push!(results, compare_tests("H0_M$(Ms[i])", tests, f_sample_data=H0_data, f_sample_tr_data=H0_data, N=N, n=n, α=α))
    push!(results, compare_tests("H1_M$(Ms[i])", tests, f_sample_data=H1_data, f_sample_tr_data=H1_data, N=N, n=n, α=α))
end
